    ...
    <section class="content-header">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pelanggan/read/'.$pelanggan->id_pel),'Read'); 
				echo ' | '; 
				echo anchor(site_url('pelanggan/update/'.$pelanggan->id_pel),'Update'); 
				echo ' | '; 
				echo anchor(site_url('pelanggan/delete/'.$pelanggan->id_pel),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
