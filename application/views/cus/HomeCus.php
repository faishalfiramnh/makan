...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Selamat Datang Kasih di Dimas Katring & Crew semoga Suka</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="apple-touch-icon" href="apple-touch-icon.png">

          <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/css/animate/animate.css">
        <link href='https://fonts.googleapis.com/css?family=Pacifico' rel='stylesheet' type='text/css'>
        <!-- <link rel="stylesheet" href="assets/css/font-awesome.min.css"> -->
        <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/fonts/fontawesome-webfont.woff">
        <!--        <link rel="stylesheet" href="assets/css/bootstrap-theme.min.css">-->


        <!--For Plugins external css-->
        <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/css/animate/animate.css" />
        <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/css/plugins.css" />

        <!--Theme custom css -->
        <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/css/style.css">

        <!--Theme Responsive css-->
        <link rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/css/responsive.css" />

        <script rel="stylesheet" href="<?= base_url('ViewHomeCus') ?>/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"></script>
    </head>
    <body>
        <!--[if lt IE 8]>
                        ...
                        <nav class="navbar navbar-default">
                            <div class="container-fluid">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand our_logo" href="#"><img src="/ViewHomeCus/images/logo.png" alt="" /></a>
                                </div>
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a href="#abouts">Pilih Pesanan</a></li>
                    ...
                    <div class="abouts_content">
                        <div class="col-md-6">
                            <div class="single_abouts_text text-center wow slideInLeft" data-wow-duration="1s">
                                <img src="ViewHomeCus/images/ab.png" alt="" />
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <h4>ini adalah varian menu kita</h4>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="main_portfolio_content">
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p1.png" alt="" />
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p2.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p3.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p4.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p5.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p6.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p7.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    <img src="ViewHomeCus/images/p8.png" alt="" />
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="" class="btn btn-primary">Click here</a>
                    ...
                    <div class="row">
                        <div class="main_mobail_apps_content wow zoomIn">
                            <div class="col-md-5 col-sm-12 text-center">
                                <img src="ViewHomeCus/images/iphone.png" alt="" />
                            </div>
                            <div class="col-md-7 col-sm-12">
                                <div class="single_monail_apps_text">
                                    ...
                                    <a href=""><img src="assetsViewHomeCus/images/google.png" alt="" /></a>
                                    <a href=""><img src="ViewHomeCus/images/apps.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="ViewHomeCus/js/vendor/jquery-1.11.2.min.js"></script>
        <script src="ViewHomeCus/js/vendor/bootstrap.min.js"></script>

        <script src="ViewHomeCus/js/jquery-easing/jquery.easing.1.3.js"></script>
        <script src="ViewHomeCus/js/wow/wow.min.js"></script>
        <script src="ViewHomeCus/js/plugins.js"></script>
        <script src="ViewHomeCus/js/main.js"></script>
    </body>
</html>
